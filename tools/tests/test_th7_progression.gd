...
func _initialize() -> void:
	...
	_expect(harpoon.get("range_levels", []) == [1.20, 1.27, 1.45, 1.64, 1.82, 1.95, 2.08, 2.20], "Harpoon range must reach Mage Tower coverage at live levels.")
	...
	_expect(is_equal_approx(harpoon_runtime.detect_range, 1.95), "Harpoon L6 range must match Mage Tower L6.")
