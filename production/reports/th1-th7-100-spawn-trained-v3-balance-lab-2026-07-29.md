...
**Generated:** 2026-07-29T11:00:04.233Z
**Seed:** 290730
...
- **WARNING / overall-win-rate:** Overall attacker win rate 35.2% is outside 55.0% +/- 8.0%.
- **WARNING / matchup-outlier:** matchup TH1->TH1 has 66.4% attacker wins across 547 samples (reference 55.0%).
- **WARNING / matchup-outlier:** matchup TH2->TH2 has 37.4% attacker wins across 676 samples (reference 55.0%).
- **WARNING / matchup-outlier:** matchup TH3->TH3 has 26.6% attacker wins across 676 samples (reference 55.0%).
- **WARNING / matchup-outlier:** matchup TH4->TH4 has 39.1% attacker wins across 713 samples (reference 55.0%).
- **WARNING / matchup-outlier:** matchup TH5->TH5 has 29.6% attacker wins across 756 samples (reference 55.0%).
...
- **WARNING / base-archetype-outlier:** base-archetype diamond has 51.2% attacker wins across 162 samples (reference 35.2%).
- **WARNING / base-archetype-outlier:** base-archetype echelon-left has 57.2% attacker wins across 152 samples (reference 35.2%).
- **WARNING / base-archetype-outlier:** base-archetype echelon-right has 71.6% attacker wins across 155 samples (reference 35.2%).
- **WARNING / base-archetype-outlier:** base-archetype rear-keep has 9.5% attacker wins across 369 samples (reference 35.2%).
- **WARNING / base-archetype-outlier:** base-archetype southern-funnel has 21.2% attacker wins across 430 samples (reference 35.2%).
- **WARNING / base-archetype-outlier:** base-archetype split-core has 62.7% attacker wins across 260 samples (reference 35.2%).
- **WARNING / base-archetype-outlier:** base-archetype wide-spread has 53.8% attacker wins across 238 samples (reference 35.2%).
- **WARNING / base-archetype-outlier:** base-archetype asymmetric-left has 12.7% attacker wins across 379 samples (reference 35.2%).
- **WARNING / base-archetype-outlier:** base-archetype asymmetric-right has 61.4% attacker wins across 176 samples (reference 35.2%).
- **WARNING / base-archetype-outlier:** base-archetype cannon-screen has 81.6% attacker wins across 163 samples (reference 35.2%).
- **WARNING / army-outlier:** army pure-demon_king has 55.7% attacker wins across 393 samples (reference 35.2%).
- **WARNING / army-outlier:** army random-4 has 15.5% attacker wins across 245 samples (reference 35.2%).
- **WARNING / army-outlier:** army random-5 has 17.9% attacker wins across 190 samples (reference 35.2%).
- **WARNING / army-outlier:** army random-2 has 20.0% attacker wins across 115 samples (reference 35.2%).
- **WARNING / troop-outlier:** troop mimic has 18.4% attacker wins across 938 samples (reference 35.2%).
- **WARNING / troop-outlier:** troop necromancer has 16.9% attacker wins across 261 samples (reference 35.2%).
...
- 116 additional findings are available in the JSON report.
