...
**Generated:** 2026-07-29T12:11:51.056Z
**Seed:** 79991
**Town Halls:** TH7
...
**Breakability probe:** 251 calibration + gate + focused rescue battles; 1/12 tested bases unbeaten; 0 untested
...
Attack policies were first calibrated against the strongest same-TH bases at common NFT rarity. Each generated base was then attacked by up to 5 best hard-base policies. Bases that survived the elite gate were tested against the remaining distinct same-TH policies until the first valid win or exhaustion of the candidate set. These probe battles do not affect the reported balance win rate.
...
- Total breakability battles: 251
- Invalid: 0
- Tested bases: 12/12
- Untested bases: 0
- Bases with zero successful attacks after full candidate search: 1

| Rescued Base | TH | Archetype | Progression | Counter Policy | Rescue Attempt |
|---|---:|---|---|---|---:|
| th7-asymmetric-left-007 | 7 | asymmetric-left | rushed-defense | policy-0049 | 13 |
| th7-layered-rings-003 | 7 | layered-rings | rushed-defense | policy-0006 | 3 |

| Base | TH | Archetype | Progression | Elite Attacks |
|---|---:|---|---|---:|
| th7-compact-core-001 | 7 | compact-core | maxed | 60 |
...
- **CRITICAL / unbreakable-base-probe:** 1/12 bases survived the elite gate and every remaining distinct same-TH attack policy at common rarity.
- **WARNING / troop-dps-outlier:** mage direct DPS/slot is 3.73x median.
- **WARNING / policy-exploration-win-rate:** Policy-exploration attacker win rate 42.4% is outside 55.0% +/- 2.0% across 132 samples. Adaptive training and controlled pure-unit battles are excluded.
- **WARNING / pure-troop-outlier:** pure-troop archer has 25.0% attacker wins across 12 samples (reference 40.7%).
- **WARNING / pure-troop-outlier:** pure-troop necromancer has 25.0% attacker wins across 12 samples (reference 40.7%).
- **WARNING / town-hall-target-band:** policy-exploration|TH7 has 42.4% attacker wins across 132 samples; authored target is 53.0%-57.0%.
