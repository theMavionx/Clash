...
interface IDemonKingBaseV2 {
    function adminMint(address to, uint256 quantity) external;
}

contract DemonKingBaseShopV2 is
    Initializable,
    OwnableUpgradeable,
    ...
    UUPSUpgradeable
{
    ...
    function initialize(
        ...
        __EIP712_init("DemonKingBaseShop", "1");
        nft = IDemonKingBaseV2(nftAddress);
