...
const CLASH_AGENT_PLAYBOOK = [
  ...
  '',
  '## Intent Mapping',
  'attack/find enemy/raid/атакуй/напади -> get_base_state -> execute_ai_attack_plan({ auto_tactics: true }) -> summarize rewards, destroyed buildings, losses, and cooldown/blocker.',
