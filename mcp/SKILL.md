...
- Close results can include `close_result.realized_pnl_usd_estimate` and `close_result.realized_pnl_pct_estimate`; report both when present and do not say PnL is pending.
