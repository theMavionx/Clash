...
const { classifyGameIntent } = require('../../server/hermes_client.js');
...
const cases = [
  ...
  ['create an hourly Decibel watcher: buy when RSI hits 25 and MACD crosses up with good volume', 'hermes_job_create', ['hermes_job_create_draft']],
  ['monitor URA price every hour and analyze RSI MACD and volume', 'hermes_job_create', ['hermes_job_create_draft']],
  ['set up cron job for BTC when rsi below 25 and volume spikes', 'hermes_job_create', ['hermes_job_create_draft']],
  ['постав робота що раз на годину дивиться RSI MACD volume по ETH', 'hermes_job_create', ['hermes_job_create_draft']],
  ['show active Hermes jobs', 'hermes_job_list', ['hermes_job_list']],
  ['pause my RSI watcher', 'hermes_job_pause', ['hermes_job_list', 'hermes_job_pause']],
  ['resume the Decibel monitor', 'hermes_job_resume', ['hermes_job_list', 'hermes_job_resume']],
  ['run my watcher now', 'hermes_job_run_now', ['hermes_job_list', 'hermes_job_run_now']],
  ...
  ['place market order long ETH 5 usdc', 'decibel_place_order', ['decibel_place_order']],
  ...
  ['close my BTC position', 'decibel_close_position', ['decibel_close_position']],
  ['reduce ETH by 50 percent', 'decibel_close_position', ['decibel_close_position']],
  ['close all SOL', 'decibel_close_position', ['decibel_close_position']],
  ...
  ['відкрий лонг BTC на 10 USDC 5x', 'decibel_place_order', ['decibel_place_order']],
  ['покажи мої позиції', 'decibel_account', ['decibel_get_account']],
  ['закрий позицію ETH', 'decibel_close_position', ['decibel_close_position']],
  ...
  ['открой шорт SOL на 15 USDC', 'decibel_place_order', ['decibel_place_order']],
  ['покажи баланс decibel', 'decibel_account', ['decibel_get_account']],
  ['купить BTC на 20 usdc', 'decibel_place_order', ['decibel_place_order']],
  ['продать ETH short', 'decibel_place_order', ['decibel_place_order']],
  ['查看 BTC 价格', 'decibel_markets', ['decibel_get_markets']],
  ['开多 BTC 10 USDC', 'decibel_place_order', ['decibel_place_order']],
  ['平仓 ETH', 'decibel_close_position', ['decibel_close_position']],
  ...
  ['show my positions', 'avantis_account', ['avantis_get_positions'], { dex: 'avantis' }],
