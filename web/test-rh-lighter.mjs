...
assert.match(hook, /referral_satisfied:/);
assert.match(hook, /value\?\.referral_exempt === true/);
assert.match(hook, /prepared\.requires_l1_signature !== false/);
assert.match(panel, /self-referral is not required/);
