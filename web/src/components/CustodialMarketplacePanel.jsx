...
const s = {
  ...
  readyBanner: { display: 'flex', justifyContent: 'space-between', gap: 10, alignItems: 'center', padding: 10, borderRadius: 10, background: 'var(--terminal-long-soft)', border: '1px solid var(--terminal-long-border)', color: 'var(--terminal-long-strong)' },
  warnBanner: { display: 'flex', justifyContent: 'space-between', gap: 10, alignItems: 'center', padding: 10, borderRadius: 10, background: 'var(--terminal-warning-soft)', border: '1px solid var(--terminal-warning-border)', color: 'var(--terminal-warning)' },
  bannerTitle: { fontSize: 13, fontWeight: 700 },
  bannerSub: { fontSize: 11, fontWeight: 700, opacity: 0.9 },
  refreshBtn: uiButton('secondary', { minHeight: 34, padding: '7px 10px', fontSize: 12 }),
  tabs: { display: 'grid', gridTemplateColumns: 'repeat(3, minmax(0, 1fr))', gap: 6, width: '100%', minWidth: 0 },
  tab: { minWidth: 0, padding: '8px 8px', borderRadius: 10, border: '1px solid var(--terminal-border)', background: 'var(--terminal-surface)', color: 'var(--terminal-text)', fontWeight: 700, cursor: 'pointer', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' },
  tabActive: { background: 'var(--terminal-brand-border)', border: '1px solid var(--terminal-text-muted)' },
  meta: { fontSize: 12, color: 'var(--terminal-text-secondary)', fontWeight: 600 },
  empty: { padding: 20, borderRadius: 10, border: '1px dashed var(--terminal-border)', background: 'var(--terminal-surface)', color: 'var(--terminal-text)', textAlign: 'center', fontWeight: 600 },
  emptyInline: { padding: 12, color: 'var(--terminal-text-secondary)', fontWeight: 600, fontSize: 12 },
  filterPanel: { width: '100%', minWidth: 0, boxSizing: 'border-box', display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: 8, padding: 7, borderRadius: 12, borderWidth: 1, borderStyle: 'solid', borderColor: 'var(--terminal-border)', background: 'linear-gradient(180deg, var(--terminal-surface) 0%, var(--terminal-brand-soft) 100%)', boxShadow: 'inset 0 2px 0 rgba(255,255,255,0.7)' },
  filterControl: { position: 'relative', minWidth: 0, zIndex: 1 },
  filterControlOpen: { zIndex: 25 },
  filterButton: { ...uiButton('secondary', { width: '100%', minWidth: 0, minHeight: 48, boxSizing: 'border-box', padding: '7px 34px 7px 10px', justifyContent: 'space-between' }), fontFamily: 'inherit', outline: 'none', textAlign: 'left' },
  filterButtonOpen: { borderColor: 'var(--terminal-orange)', background: 'var(--terminal-brand-soft)', color: 'var(--terminal-brand-text)' },
  filterTextWrap: { minWidth: 0, display: 'flex', flexDirection: 'column', gap: 3 },
  filterLabel: { color: 'var(--terminal-text-muted)', fontSize: 9, fontWeight: 700, textTransform: 'uppercase', lineHeight: 1, letterSpacing: 0 },
  filterValue: { minWidth: 0, color: 'var(--terminal-text)', fontSize: 14, fontWeight: 700, lineHeight: 1.05, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' },
  filterChevron: { position: 'absolute', right: 13, top: '50%', width: 8, height: 8, borderRightWidth: 2, borderRightStyle: 'solid', borderRightColor: 'var(--terminal-text)', borderBottomWidth: 2, borderBottomStyle: 'solid', borderBottomColor: 'var(--terminal-text)', transform: 'translateY(-65%) rotate(45deg)', transition: 'transform 0.14s ease' },
  filterChevronOpen: { transform: 'translateY(-35%) rotate(225deg)' },
  filterMenu: { position: 'absolute', top: 'calc(100% + 5px)', left: 0, right: 0, zIndex: 30, padding: 5, borderRadius: 10, borderWidth: 1, borderStyle: 'solid', borderColor: 'var(--terminal-text-muted)', background: 'var(--terminal-surface)', boxShadow: '0 10px 18px rgba(65,42,20,0.24), inset 0 1px 0 rgba(255,255,255,0.75)', display: 'flex', flexDirection: 'column', gap: 4 },
  filterOption: { position: 'relative', width: '100%', minHeight: 40, padding: '6px 28px 6px 8px', borderRadius: 8, borderWidth: 0, background: 'transparent', color: 'var(--terminal-text)', cursor: 'pointer', fontFamily: 'inherit', textAlign: 'left', display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: 2 },
  filterOptionActive: { background: 'var(--terminal-brand-soft)', color: 'var(--terminal-brand-text)', boxShadow: 'inset 0 0 0 1px var(--terminal-orange)' },
  filterOptionLabel: { fontSize: 13, fontWeight: 700, lineHeight: 1 },
  filterOptionSub: { fontSize: 10, fontWeight: 600, color: 'var(--terminal-text-muted)', lineHeight: 1.05 },
  filterOptionMark: { position: 'absolute', right: 9, top: '50%', width: 9, height: 5, borderLeftWidth: 2, borderLeftStyle: 'solid', borderLeftColor: 'var(--terminal-text)', borderBottomWidth: 2, borderBottomStyle: 'solid', borderBottomColor: 'var(--terminal-text)', transform: 'translateY(-65%) rotate(-45deg)' },
  ...
  card: { minWidth: 0, display: 'flex', flexDirection: 'column', gap: 5, padding: 8, borderRadius: 10, border: '1px solid var(--terminal-border)', background: 'var(--terminal-surface)', boxSizing: 'border-box' },
  cardMobile: { width: '100%', minWidth: 0, boxSizing: 'border-box', display: 'grid', gridTemplateColumns: '86px minmax(0, 1fr)', alignItems: 'stretch', gap: 8, padding: 7, borderRadius: 10, border: '1px solid var(--terminal-border)', background: 'var(--terminal-surface)', minHeight: 104 },
  cardBody: { minWidth: 0, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', gap: 5 },
  imgWrap: { position: 'relative', aspectRatio: '1 / 1', boxSizing: 'border-box', borderRadius: 8, overflow: 'hidden', background: 'var(--terminal-surface)', border: '1px solid var(--terminal-border)' },
  imgWrapMobile: { position: 'relative', width: 86, height: 86, boxSizing: 'border-box', borderRadius: 8, overflow: 'hidden', background: 'var(--terminal-surface)', border: '1px solid var(--terminal-border)' },
  img: { width: '100%', height: '100%', objectFit: 'cover' },
  level: { position: 'absolute', top: 4, right: 4, padding: '2px 5px', borderRadius: 5, background: 'var(--terminal-text)', color: 'var(--terminal-surface)', fontSize: 10, fontWeight: 700 },
  cardLine: { minWidth: 0, display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', gap: 8, fontSize: 12, color: 'var(--terminal-text)' },
  ...
  cardSub: { minWidth: 0, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', fontSize: 10, color: 'var(--terminal-text-secondary)', fontWeight: 700 },
  cardBtn: uiButton('primary', { width: '100%', minHeight: 34, padding: '7px 10px', fontSize: 12 }),
  cardBtnMobile: { minHeight: 34, padding: '7px 8px' },
  manageBtn: uiButton('secondary', { width: '100%', minHeight: 34, padding: '7px 10px', fontSize: 12 }),
  ...
  formLabel: { fontSize: 12, color: 'var(--terminal-text)', fontWeight: 700, textTransform: 'uppercase' },
  nftRow: { display: 'flex', gap: 8, overflowX: 'auto', padding: 6, borderRadius: 10, border: '1px solid var(--terminal-border)', background: 'var(--terminal-surface)' },
  nftPick: { width: 104, flexShrink: 0, display: 'flex', flexDirection: 'column', gap: 4, alignItems: 'center', borderRadius: 8, border: '1px solid transparent', background: 'var(--terminal-surface)', padding: 5, color: 'var(--terminal-text)', fontSize: 10, fontWeight: 600, cursor: 'pointer' },
  nftPickActive: { border: '1px solid var(--terminal-text-muted)', background: 'var(--terminal-brand-border)' },
  ...
  connectedLine: { fontSize: 11, color: 'var(--terminal-text-secondary)', fontWeight: 600 },
  feeLine: { fontSize: 11, color: 'var(--terminal-text-secondary)', fontWeight: 600, background: 'var(--terminal-surface)', border: '1px solid var(--terminal-border)', borderRadius: 8, padding: '7px 9px' },
  label: { display: 'flex', flexDirection: 'column', gap: 5, fontSize: 12, color: 'var(--terminal-text)', fontWeight: 700 },
  input: { padding: '9px 10px', borderRadius: 8, border: '1px solid var(--terminal-border)', background: 'var(--terminal-surface)', color: 'var(--terminal-text)', fontWeight: 600 },
  primaryBtn: { ...uiButton('primary', { width: '100%', padding: 11 }) },
  smallBtn: { ...uiButton('secondary', { minHeight: 32, padding: '6px 9px', fontSize: 11 }) },
  orderList: { display: 'flex', flexDirection: 'column', gap: 8 },
  orderRow: { display: 'flex', alignItems: 'center', gap: 9, padding: 8, borderRadius: 10, border: '1px solid var(--terminal-border)', background: 'var(--terminal-surface)' },
  orderImg: { width: 54, height: 54, objectFit: 'cover', borderRadius: 8, border: '1px solid var(--terminal-border)' },
  orderMain: { flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: 2, fontSize: 11, color: 'var(--terminal-text)', fontWeight: 700 },
  orderActions: { display: 'flex', flexDirection: 'column', gap: 5, alignItems: 'stretch' },
  orderReserved: { color: 'var(--terminal-text-secondary)', fontWeight: 700 },
  orderError: { color: 'var(--terminal-short-strong)', fontWeight: 700 },
  ...
  modal: { width: 380, maxWidth: 'calc(100vw - 20px)', maxHeight: 'calc(100dvh - 20px)', padding: 12, borderRadius: 14, border: '1px solid var(--terminal-border)', background: 'var(--terminal-surface)', display: 'flex', flexDirection: 'column', gap: 10, boxSizing: 'border-box', overflowY: 'auto', WebkitOverflowScrolling: 'touch' },
  modalCompact: { width: 'calc(100vw - 20px)', padding: 8, gap: 8, borderWidth: 1, borderRadius: 12 },
  walletModal: { width: 360, maxWidth: 'calc(100vw - 20px)', maxHeight: 'calc(100dvh - 20px)', padding: 12, borderRadius: 14, border: '1px solid var(--terminal-border)', background: 'var(--terminal-surface)', display: 'flex', flexDirection: 'column', gap: 10, boxShadow: '0 18px 50px rgba(0,0,0,0.45)', boxSizing: 'border-box', overflowY: 'auto', WebkitOverflowScrolling: 'touch' },
  modalHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center' },
  modalTitle: { fontSize: 16, fontWeight: 700, color: 'var(--terminal-text)' },
  closeBtn: uiIconButton('danger', 28),
  walletModalSub: { fontSize: 12, fontWeight: 600, color: 'var(--terminal-text-secondary)', lineHeight: 1.35 },
  walletChoiceList: { display: 'flex', flexDirection: 'column', gap: 7 },
  walletChoiceBtn: { width: '100%', minHeight: 54, display: 'flex', alignItems: 'center', gap: 10, padding: '8px 10px', borderRadius: 10, border: '1px solid var(--terminal-border)', background: 'var(--terminal-surface)', color: 'var(--terminal-text)', cursor: 'pointer', fontFamily: 'inherit', textAlign: 'left' },
  walletChoiceBadge: { width: 38, height: 34, borderRadius: 9, background: 'var(--terminal-surface)', border: '1px solid rgba(92,58,33,0.22)', color: 'var(--terminal-text)', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontSize: 9, fontWeight: 700, letterSpacing: 0.4, flex: '0 0 auto', overflow: 'hidden', boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.75)' },
  ...
  walletChoiceName: { fontSize: 13, fontWeight: 700, color: 'var(--terminal-text)' },
  walletChoiceStatus: { fontSize: 10, fontWeight: 600, color: 'var(--terminal-text-secondary)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
  walletChoiceAction: { flex: '0 0 auto', fontSize: 11, fontWeight: 700, color: 'var(--terminal-info)', textTransform: 'uppercase' },
  modalImg: { width: '100%', aspectRatio: '1 / 1', maxHeight: 'min(310px, 42dvh)', objectFit: 'cover', borderRadius: 10, border: '1px solid var(--terminal-border)', background: 'var(--terminal-surface)', alignSelf: 'center' },
  modalImgCompact: { width: 'min(100%, 260px)', maxHeight: '34dvh', borderRadius: 8 },
  progressHead: { display: 'flex', gap: 10, alignItems: 'center', padding: 8, borderRadius: 10, border: '1px solid var(--terminal-border)', background: 'var(--terminal-surface)' },
  progressImg: { width: 72, height: 72, objectFit: 'cover', borderRadius: 8, border: '1px solid var(--terminal-border)', background: 'var(--terminal-surface)' },
  progressMeta: { minWidth: 0, display: 'flex', flexDirection: 'column', gap: 3, color: 'var(--terminal-text)', fontSize: 12, fontWeight: 600 },
  stepList: { display: 'flex', flexDirection: 'column', gap: 6 },
  stepRow: { display: 'flex', alignItems: 'center', gap: 8, padding: '7px 8px', borderRadius: 8, border: '1px solid var(--terminal-border)', background: 'var(--terminal-surface)', color: 'var(--terminal-text-secondary)', fontSize: 12, fontWeight: 700 },
  stepRowActive: { background: 'var(--terminal-brand-soft)', color: 'var(--terminal-text)' },
  stepRowError: { background: 'var(--terminal-short-soft)', color: 'var(--terminal-short-strong)' },
  stepDot: { width: 28, height: 22, borderRadius: 7, border: '1px solid var(--terminal-border)', background: 'var(--terminal-surface)', color: 'var(--terminal-text-secondary)', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontSize: 10, fontWeight: 700 },
  stepDotDone: { border: '1px solid var(--terminal-long)', background: 'var(--terminal-long)', color: 'var(--terminal-long-strong)' },
  stepDotActive: { border: '1px solid var(--terminal-text-muted)', background: 'var(--terminal-brand-border)', color: 'var(--terminal-text)' },
  stepDotError: { border: '1px solid var(--terminal-short)', background: 'var(--terminal-short)', color: 'var(--terminal-on-accent)' },
  progressMessage: { padding: '7px 8px', borderRadius: 8, background: 'var(--terminal-surface)', color: 'var(--terminal-text)', fontSize: 12, fontWeight: 600 },
  progressError: { padding: '7px 8px', borderRadius: 8, background: 'var(--terminal-short-soft)', color: 'var(--terminal-short-strong)', fontSize: 12, fontWeight: 700 },
  progressLinks: { display: 'flex', flexDirection: 'column', gap: 2, color: 'var(--terminal-text-secondary)', fontSize: 11, fontWeight: 600 },
  breakdown: { display: 'grid', gridTemplateColumns: 'auto minmax(0, 1fr)', gap: 6, padding: 8, borderRadius: 8, border: '1px solid var(--terminal-border)', background: 'var(--terminal-surface)', color: 'var(--terminal-text)', fontSize: 12, minWidth: 0 },
  ...
  chip: { minWidth: 72, minHeight: 34, padding: '4px 8px', borderRadius: 7, border: '1px solid var(--terminal-border)', background: 'var(--terminal-surface)', color: 'var(--terminal-text)', fontWeight: 700, cursor: 'pointer', display: 'inline-flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 1, lineHeight: 1.05 },
  chipLabel: { display: 'block', fontSize: 12, whiteSpace: 'nowrap' },
  chipStatus: { display: 'block', fontSize: 9, color: 'var(--terminal-text-muted)', whiteSpace: 'nowrap' },
  chipActive: { background: 'var(--terminal-brand-border)', border: '1px solid var(--terminal-text-muted)' },
  chipMuted: { opacity: 0.65 },
  connectWalletBtn: uiButton('primary', { justifySelf: 'start', minHeight: 32, padding: '6px 9px', fontSize: 11 }),
  notice: { padding: 8, borderRadius: 8, border: '1px solid var(--terminal-warning-border)', background: 'var(--terminal-warning-soft)', color: 'var(--terminal-warning)', fontSize: 12, fontWeight: 600 },
  noticeOk: { padding: 8, borderRadius: 8, border: '1px solid var(--terminal-long-border)', background: 'var(--terminal-long-soft)', color: 'var(--terminal-long-strong)', fontSize: 12, fontWeight: 600 },
};
