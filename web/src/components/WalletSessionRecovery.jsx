...
const DEX_WALLET = {
  ...
  domfi: { kind: 'evm', chain: 'Base', label: 'DomFi', cta: 'Reconnect Base wallet', targetChain: 'base' },
  etoro: { kind: 'evm', chain: 'EVM login', label: 'eToro', cta: 'Reconnect Clash login wallet', targetChain: 'baseConnect' },
