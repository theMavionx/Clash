...
const S = {
  ...
  modal: {
    ...
    maxWidth: 460, width: '100%', boxShadow: 'var(--terminal-shadow-card)',
  },
  header: { display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 },
  brain: {
    display: 'inline-flex', alignItems: 'center', justifyContent: 'center',
    width: 28, height: 28, borderRadius: '50%',
    background: 'var(--terminal-text)', color: 'var(--terminal-on-accent)', fontSize: 18, fontWeight: 700,
  },
  title: { fontSize: 16, fontWeight: 700, color: 'var(--terminal-text)', flex: 1, margin: 0 },
  closeBtn: uiIconButton('secondary', 34, { fontSize: 18 }),
  loading: { fontSize: 13, color: 'var(--terminal-text-muted)', fontWeight: 700, padding: '20px 0', textAlign: 'center' },
  error: { fontSize: 13, color: 'var(--terminal-short)', fontWeight: 700, padding: '12px 0' },
  text: { fontSize: 14, color: 'var(--terminal-text)', lineHeight: 1.5, fontWeight: 600, marginBottom: 14 },
  poweredBy: {
    display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6,
    fontSize: 10, color: 'var(--terminal-text-muted)', marginTop: 12, fontWeight: 700, letterSpacing: '0.03em', textTransform: 'uppercase',
  },
