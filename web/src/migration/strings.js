...
export const messages = {
  ...
  quoteReservation: 'This review reserves the quoted amount from your allocation. A reservation is not a token transfer; unused allocation is released when the unsigned quote expires or is cancelled.',
