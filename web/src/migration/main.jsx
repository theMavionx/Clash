...
function Migration() {
  ...
  return <div className="dashboard-app migration-app">
    ...
    <main id="migration-main" className="migration-shell">
      <div className="migration-intro"><p className="migration-eyebrow">{t('subtitle')}</p><h1>{t('title')}</h1><p className="migration-muted">{t('intro')}</p></div>
