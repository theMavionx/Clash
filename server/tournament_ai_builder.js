...
const TOURNAMENT_DEXES = new Set([
  'pacifica', 'avantis', 'decibel', 'dango', 'gmx', 'ostium', 'monad', 'phoenix',
...
const TOURNAMENT_FIELDS = new Set([
  ...
  'attack_match_policy', 'start_at', 'end_at', 'preregistration_enabled', 'registration_opens_at',
