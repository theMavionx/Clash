...
try {
  db.exec(`
    CREATE TABLE IF NOT EXISTS tournaments (
      ...
      name         TEXT NOT NULL,
      description  TEXT,
      dex          TEXT NOT NULL CHECK(dex IN ('pacifica','avantis','domfi','etoro','decibel','dango','gmx','ostium','monad','phoenix','hyperliquid','risex','nado','ondo','hibachi','hotstuff','grvt','katana','gmtrade','flash','lighter','rhlighter','bulk','imperial')),
      ...
      db.transaction(() => {
        db.exec(`
          ...
          SELECT
            ...
            name, description,
            CASE WHEN dex IN ('pacifica','avantis','domfi','etoro','decibel','dango','gmx','ostium','monad','phoenix','hyperliquid','risex','nado','ondo','hibachi','hotstuff','grvt','katana','gmtrade','flash','lighter','rhlighter','bulk','imperial') THEN dex ELSE 'pacifica' END,
            ...
            CASE
              ...
              ELSE '["' || CASE WHEN dex IN ('pacifica','avantis','domfi','etoro','decibel','dango','gmx','ostium','monad','phoenix','hyperliquid','risex','nado','ondo','hibachi','hotstuff','grvt','katana','gmtrade','flash','lighter','rhlighter','bulk','imperial') THEN dex ELSE 'pacifica' END || '"]'
            END,
