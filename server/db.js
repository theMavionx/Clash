...
try {
  db.exec(`
    CREATE TABLE IF NOT EXISTS tournaments (
      ...
      name         TEXT NOT NULL,
      description  TEXT,
      dex          TEXT NOT NULL CHECK(dex IN ('pacifica','avantis','decibel','dango','gmx','ostium','monad','phoenix','hyperliquid','risex','nado','ondo','hibachi','hotstuff','grvt','katana','gmtrade','flash','lighter','bulk')),
  ...
  try {
    ...
    const needsRebuild = schema
      && (!schema.includes("event_kind") || !schema.includes("'points'") || !schema.includes("'volume_trophies_50_50'") || !schema.includes("'dango'") || !schema.includes("'ostium'") || !schema.includes("'monad'") || !schema.includes("'phoenix'") || !schema.includes("'hyperliquid'") || !schema.includes("'risex'") || !schema.includes("'nado'") || !schema.includes("'ondo'") || !schema.includes("'hibachi'") || !schema.includes("'grvt'") || !schema.includes("'katana'") || !schema.includes("'gmtrade'") || !schema.includes("'flash'") || !schema.includes("'lighter'") || !schema.includes("'bulk'") || !schema.includes("points_trophy_weight") || !schema.includes("scoring_mode") || !schema.includes("daily_pool_points") || !schema.includes("daily_pool_growth_pct") || !schema.includes("daily_pool_overrides") || !schema.includes("daily_pool_award_time_utc") || !schema.includes("prize_tiers") || !schema.includes("mega_config") || !schema.includes("reward_config") || !schema.includes("rewards_in_cop") || !schema.includes("seeker_only") || !schema.includes("seeker_gold_boost") || !schema.includes("shield_hours") || !schema.includes("dex_scope") || !schema.includes("eligible_dexes") || !schema.includes("dex_vs_dex") || !schema.includes("team_prize_splits") || !schema.includes("attack_match_policy"));
    if (needsRebuild) {
      ...
      db.transaction(() => {
        db.exec(`
          ...
          SELECT
            ...
            name, description,
            CASE WHEN dex IN ('pacifica','avantis','decibel','dango','gmx','ostium','monad','phoenix','hyperliquid','risex','nado','ondo','hibachi','hotstuff','grvt','katana','gmtrade','flash','lighter','bulk') THEN dex ELSE 'pacifica' END,
            ...
            CASE
              ...
              ELSE '["' || CASE WHEN dex IN ('pacifica','avantis','decibel','dango','gmx','ostium','monad','phoenix','hyperliquid','risex','nado','ondo','hibachi','hotstuff','grvt','katana','gmtrade','flash','lighter','bulk') THEN dex ELSE 'pacifica' END || '"]'
            END,
