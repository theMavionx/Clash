...
const DEFENSE_STATS = {
  turret: {
    ...
    2: { damage: 56, fireRate: 0.52, detectRange: 1.02, projSpeed: 4.0 },
    3: { damage: 92, fireRate: 0.38, detectRange: 1.12, projSpeed: 4.0 },
    4: { damage: 124, fireRate: 0.33, detectRange: 1.18, projSpeed: 4.0 },
  },
  archer_tower: {
    1: { damage: 25, fireRate: 1.0,  detectRange: 1.0, projSpeed: 2.5 },
    2: { damage: 44, fireRate: 0.80, detectRange: 1.18, projSpeed: 2.5 },
    3: { damage: 82, fireRate: 0.60, detectRange: 1.38, projSpeed: 2.5 },
    4: { damage: 112, fireRate: 0.50, detectRange: 1.52, projSpeed: 2.5 },
    5: { damage: 146, fireRate: 0.43, detectRange: 1.68, projSpeed: 2.5 },
  },
  mage_tower: {
    1: {
      beam: true,
