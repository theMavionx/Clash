...
MODEL_CHAIN="${MODEL_CHAIN:-openai/gpt-oss-120b,qwen/qwen3-30b-a3b-instruct-2507:nitro,google/gemma-4-26b-a4b-it:nitro}"
...
CLASH_HERMES_PROVIDER_ORDER=${CLASH_HERMES_PROVIDER_ORDER:-cerebras}
