...
DEFAULT_MODEL_CHAIN="openai/gpt-oss-120b:free,google/gemma-4-26b-a4b-it:nitro"
...
ensure_env() {
  ...
  set_env_value CLASH_HERMES_PRIMARY_RETRIES "${CLASH_HERMES_PRIMARY_RETRIES:-3}"
  set_env_value CLASH_HERMES_FALLBACK_AFTER_RETRIES "${CLASH_HERMES_FALLBACK_AFTER_RETRIES:-3}"
  ...
  set_env_value CLASH_HERMES_ACTION_CHAT_TIMEOUT_MS "${CLASH_HERMES_ACTION_CHAT_TIMEOUT_MS:-240000}"
