...
DEFAULT_MODEL_CHAIN="openai/gpt-oss-120b,qwen/qwen3-30b-a3b-instruct-2507:nitro,google/gemma-4-26b-a4b-it:nitro"
...
ensure_env() {
  ...
  set_env_value CLASH_HERMES_PROVIDER_ORDER "${CLASH_HERMES_PROVIDER_ORDER:-cerebras}"
  set_env_value CLASH_HERMES_PRIMARY_RETRIES "${CLASH_HERMES_PRIMARY_RETRIES:-1}"
  set_env_value CLASH_HERMES_FALLBACK_AFTER_RETRIES "${CLASH_HERMES_FALLBACK_AFTER_RETRIES:-1}"
  set_env_value CLASH_HERMES_CHAT_TIMEOUT_MS "${CLASH_HERMES_CHAT_TIMEOUT_MS:-20000}"
  set_env_value CLASH_HERMES_ACTION_PRIMARY_RETRIES "${CLASH_HERMES_ACTION_PRIMARY_RETRIES:-1}"
  set_env_value CLASH_HERMES_ACTION_FALLBACK_RETRIES "${CLASH_HERMES_ACTION_FALLBACK_RETRIES:-1}"
  set_env_value CLASH_HERMES_ACTION_CHAT_TIMEOUT_MS "${CLASH_HERMES_ACTION_CHAT_TIMEOUT_MS:-45000}"
